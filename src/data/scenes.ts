...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    dialogue: [
      { speaker: "점장님", text: "자, 지후 학생이었나? 오늘부터 우리 편의점 오전 알바를 맡게 되었군. 솔직히 말하자면 이번 달 본사 평가가 마지막 기회일세. 민원도, 사고도, 매출 손실도 더는 안 돼. 자네가 이 가게의 분위기를 바꿔줘야 하네." },
    ],
    choices: [
      {
        id: "warm_start",
  ...
  },
  {
    ...
    success: {
      ...
      dialogue: [
        ["지후", "점장님! 이의 있습니다!"],
        ["지후", "근로기준법 제17조에 따르면 근로계약은 체결 시점에 임금, 근로시간, 주휴일 등 핵심 조건을 서면으로 명시해 교부해야 합니다!"],
        ["지후", "한 달 뒤에 쓰겠다는 것은 명백한 위법이며, 위반 시 500만 원 이하의 벌금이 부과될 수 있습니다!"],
        ["점장님", "으윽... 지금은 서류보다 손님이 더 급한데 말이지."],
        ["지후", "그래서 더 지금 해야 합니다. 나중에 문제가 터지면 손님보다 서류가 먼저 우리 발목을 잡을 테니까요."],
        ["점장님", "알았네. 모바일 계약서라도 지금 작성하지. 자네 말대로, 무너지는 가게일수록 기본부터 지켜야겠군."],
        ["지후", "첫날부터 불편한 말을 꺼냈지만, 이 가게에서 내 권리도 책임도 분명해졌다."]
      ],
  ...
  },
  {
    ...
    dialogue: [
      { speaker: "수진이", text: "오빠, 저기 매대 뒤에 들어온 한정판 빵 딱 하나 있죠? 어제부터 기다렸어요. 저 단골인 거 알잖아요. 오늘만 몰래 빼두면 안 돼요? 부탁 하나 들어주면 친구들한테 여기 좋다고 소문낼게요." },
    ],
    choices: [
      {
        id: "reserve_bread",
        ...
        result: [
          { speaker: "나레이션", text: "수진이는 활짝 웃으며 인증 사진을 올립니다. 하지만 잠시 뒤 같은 빵을 사려고 뛰어온 다른 손님이 빈 매대를 보고 실망합니다. 한 사람의 호의가 다른 사람에게는 불공정으로 보이기 시작합니다." },
        ],
      ...
      },
      {
        ...
        result: [
          { speaker: "수진이", text: "오빠 너무 원칙적인 거 아니에요?", focus: "12_Sujin_Sad.png" },
          { speaker: "지후", text: "나도 미안해. 대신 다음 입고 시간은 알려줄게. 그때는 네가 직접 와서 사.", focus: "04_Jihu_Determined.png" },
          { speaker: "나레이션", text: "수진이는 서운한 표정으로 물러납니다. 그래도 매대 앞에 있던 손님들이 조용히 고개를 끄덕입니다. 단골을 잃을 위험을 감수했지만, 가게의 규칙이 사람마다 달라지지 않는다는 신뢰를 남겼습니다." },
        ],
  ...
  },
  {
    ...
    dialogue: [],
    testimony: [
      { text: "아저씨! 저기 진열된 25만 원짜리 게임기 주세요. 오늘 꼭 사야 해요.", speaker: "초등학생" },
      { text: "이거 부모님 카드인데, 엄마 심부름으로 대신 사러 온 거라 그냥 긁어주시면 돼요.", speaker: "초등학생", isContradiction: true, correctLaw: "civil_5" },
      { text: "진짜 허락받았어요. 근데 지금 전화하면 엄마 회의 중이라 혼나요. 빨리 해주세요.", speaker: "초등학생" }
    ],
    success: {
      ...
      dialogue: [
        ["지후", "잠깐 기다려! 이의 있습니다!"],
        ["지후", "민법 제5조에 따르면 미성년자와 같은 제한능력자의 고가 거래 행위는 법정대리인의 동의가 필요하며, 동의 없는 거래는 부모가 언제든 취소할 수 있습니다!"],
        ["지후", "부모님의 직접 확인 없이 결제했다가 나중에 기기를 뜯어 오면 매장은 고스란히 중고 손실을 떠안아야 합니다. 부모님 통화가 필수입니다!"],
        ["초등학생", "엄마한테 전화요? 어... 그러면 오늘은 그냥 갈게요."],
        ["지후", "아이가 나가자 매대 위 게임기가 다시 조용해졌다. 팔지 않은 물건 하나가 오히려 가게를 지킨 셈이다."]
      ],
  ...
  },
  {
    ...
    dialogue: [],
    testimony: [
      { text: "담배 한 갑 주세요. 신분증 실물은 집에 두고 왔는데요...", speaker: "수상한 청소년" },
      { text: "여기 폰에 찍어둔 주민등록증 사진 있어요. 얼굴 똑같죠? 이 정도면 확인된 거잖아요.", speaker: "수상한 청소년", isContradiction: true, correctLaw: "youth_28" },
      { text: "사장님들 다 이렇게 해주시던데요. 여기만 안 해주면 제가 리뷰에 그대로 씁니다?", speaker: "수상한 청소년" }
    ],
    success: {
      ...
      dialogue: [
        ["지후", "잠깐! 이의 있습니다!"],
        ["지후", "청소년보호법 제28조에 따르면 청소년유해매체물 판매 시 구매자의 연령을 실물 신분증 또는 행정앱 모바일 신분증으로 엄격히 확인해야 합니다!"],
        ["지후", "단순히 스마트폰에 저장된 신분증 사진이나 이미지는 법적 효력이 있는 인증 수단이 될 수 없습니다!"],
        ["수상한 청소년", "진짜 너무 깐깐하시네. 됐어요, 다른 데 갈게요."],
        ["지후", "청소년이 궁얼거리며 나가자, 매대 뒤에서 긴장했던 손가락이 조금 풀렸다. 이 한 갑의 매출보다 가게의 존립이 더 무겁다."]
      ],
  ...
  },
  {
    ...
    dialogue: [
      { speaker: "나 (지후)", text: "(점심시간은 밀렸고 손은 떨린다. 폐기 예정 박스 안에 유통기한이 막 지난 만두와 삼각김밥이 보인다. 점장님은 CCTV를 본다고 했고, 내 지갑에는 컵라면 살 돈 정도만 남아 있다. 오늘 하루가 이렇게 길 줄은 몰랐다.)" },
    ],
    choices: [
      {
        id: "eat_disposal",
        ...
        result: [
          { speaker: "나레이션", text: "배고픔은 사라졌지만 마음이 불편합니다. CCTV 화면을 확인한 점장님은 아무 말 없이 폐기 기록을 다시 열어봅니다. 작은 예외 하나가 오늘 쌓아온 신뢰를 흔듭니다." },
        ],
      ...
      },
      {
        ...
        result: [
          { speaker: "나레이션", text: "잔고는 줄었지만, 계산 영수증을 주머니에 넣는 순간 마음이 편해집니다. 점장님은 CCTV를 보다가 짧게 웃습니다. 위기의 가게에서 믿음은 이런 작은 장면으로 쌓입니다." },
        ],
  ...
  },
  {
    ...
    dialogue: [
      { speaker: "나 (지후)", text: "(아까 뛰어나간 아이들이 우유 코너 앞에서 초코우유를 엎지르고 사라졌다. 바닥은 미끄럽고 계산대 앞 줄은 길어진다. 본사 평가표에는 '대기 시간'도 있고 '안전 사고'도 있다. 둘 다 놓치면 끝이다.)" },
    ],
    choices: [
      {
        id: "clean_first",
        ...
        result: [
          { speaker: "나레이션", text: "대기 줄에서 작은 불평이 나오지만, 바닥을 닦고 표지판을 세우자 어르신들이 조심히 지나갑니다. 매출은 잠깐 느려졌지만, 사고가 나지 않는 평온함의 가치가 드러납니다." },
        ],
      ...
      },
      {
        ...
        result: [
          { speaker: "나레이션", text: "계산 줄은 빨리 줄어듭니다. 하지만 바닥 한가운데 남은 초코우유는 조용히 다음 문제를 기다립니다. 숫자로 보이는 매출을 지키느라 보이지 않는 위험을 키웠습니다." },
        ],
  ...
  },
  {
    ...
    dialogue: [],
    testimony: [
      { text: "아이고 허리야! 편의점 바닥에 초코우유가 있었는데 왜 그대로 둔 겁니까?", speaker: "다친 회사원" },
      { text: "가게 잘못이니까 치료비랑 양복값 100만 원 전액을 지금 현금으로 보내세요. 보험 말고 바로요.", speaker: "다친 회사원", isContradiction: true, correctLaw: "civil_750" },
      { text: "안 그럴 거면 리뷰, 신고, 소송까지 전부 갑니다. 본사 평가 중이라면서요?", speaker: "다친 회사원" }
    ],
    success: {
      ...
      playerPose: "04_Jihu_Determined.png",
      dialogue: [
        ["지후", "손님, 진정하십시오! 이의 있습니다!"],
        ["지후", "민법 제750조 및 불법행위 책임에 따르면 피해자의 과실도 손해배상 범위에 참작하는 과실상계 원칙이 적용됩니다!"],
        ["지후", "바닥을 잘 살피지 않은 손님의 주의 의무 위반도 공동 과실로 산정되므로, 현장에서 100% 무조건 전액을 보상하라는 요구는 법리적으로 타당하지 않습니다. 공식 보험 절차를 거치겠습니다!"],
        ["다친 회사원", "보험 접수라... 바로 돈을 주진 않겠다는 거군요."],
        ["지후", "책임을 피하겠다는 뜻이 아닙니다. 책임을 정확히 정하자는 뜻입니다. 사고 기록과 CCTV를 남기고 절차대로 처리하겠습니다."],
        ["다친 회사원", "좋습니다. 접수번호 주세요. 대신 대충 넘기면 그때는 진짜 문제 삼겠습니다."],
        ["지후", "가게의 잘못을 인정할 부분과 부당한 요구를 거절할 부분을 나눠야 한다. 법은 싸우기 위한 말이 아니라, 더 크게 무너지지 않기 위한 선이었다."]
      ],
  ...
  },
  {
    ...
    dialogue: [
      { speaker: "치즈 고양이", text: "야옹... (비가 굵어지는 밤, 야외 테이블 밑에서 작은 고양이가 떨고 있다. 매대 구석에는 포장이 뜯겨 폐기 예정인 소시지가 있다. 오늘 하루 종일 원칙만 말한 내가, 이번에도 같은 얼굴을 할 수 있을까?)" },
    ],
    choices: [
      {
        id: "feed_cat",
        ...
        result: [
          { speaker: "나레이션", text: "지나가던 주민들은 따뜻하다며 사진을 찍습니다. 하지만 먹이를 둔 자리에 다른 동물들이 모이고, 다음 날 테이블 주변 민원이 들어옵니다. 선의가 관리되지 않으면 또 다른 책임이 됩니다." },
        ],
      ...
      },
      {
        ...
        result: [
          { speaker: "나레이션", text: "마음은 무겁지만 매장 안팎의 위생 기준을 지켰습니다. 단순히 쫓아낸 것이 아니라 위험한 영업 공간 밖으로 이동시켜, 연민과 책임 사이의 최소한의 균형을 찾았습니다." },
        ],
  ...
  },
  {
    ...
    dialogue: [],
    testimony: [
      { text: "지후 군, 이번 한 달 정말 버거웠지. 그래도 본사 평가표가 예전보다는 나아졌네. 여기 월급 보낸 내역 확인해보게.", speaker: "점장님" },
      { text: "아, 저번 낙상 사고 처리비 10만 원은 월급에서 미리 뺐네. 자네도 그날 근무자였으니 서로 책임을 나누는 걸로 하세.", speaker: "점장님", isContradiction: true, correctLaw: "labor_43" },
      { text: "우리 둘 다 이 가게 살리려고 고생했잖아. 법으로만 따지면 너무 차갑지 않나?", speaker: "점장님" }
    ],
    success: {
      ...
      dialogue: [
        ["지후", "점장님! 이의 있습니다!"],
        ["지후", "근로기준법 제43조 임금 지급 원칙에 따르면 임금은 직접 근로자에게 그 전액을 지급해야 합니다!"],
        ["지후", "고용주가 손해배상 청구권 등을 이유로 근로자의 동의 없이 임금을 일방적으로 삭감하고 이체하는 행위는 엄격히 금지됩니다! 별도로 청구하셔야 합니다!"],
        ["점장님", "자네 말은 늘 맞는데, 가끔은 참 아프게 맞는군."],
        ["지후", "저도 압니다. 하지만 제 월급을 지키는 일이 점장님을 공격하는 일은 아니라고 생각합니다."],
        ["점장님", "그래. 내가 선을 넘었네. 방금 10만 원 다시 보냈네. 가게가 힘들다고 사람의 몫까지 흐리면 안 되지."],
        ["지후", "오늘 내가 지킨 것은 돈만이 아니었다. 앞으로 이 가게에서 서로를 대하는 기준이었다."]
      ],
